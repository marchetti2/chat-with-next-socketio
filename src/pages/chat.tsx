...
const Chat: React.FC = (/*{ posts }*/) => {
 ...
 // const [align, setAlign] = useState<string>("flex-end");
  ...
  useEffect(() => {
    socket.on('returnedMessage', (msg: Messages): void => {
      const msgIndex = msg.length> 0?msg[msg.length - 1].message:""
  ...
  const handleSend = useCallback(() => {
    ...
    socket.on('returnedMessage', (msg: Messages): void => {
      console.log('resre')
      const msgIndex = msg[msg.length - 1].message
